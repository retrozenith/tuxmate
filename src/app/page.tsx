        ...
        <div className="flex-1 overflow-y-auto p-4 space-y-5" style={{ scrollbarGutter: "stable" }}>
          ...
          <div className="pt-3 border-t border-[var(--border-primary)]">
            ...
            <div className="space-y-2.5 text-xs text-[var(--text-muted)] leading-relaxed">
              <p>
                Greyed-out apps aren&apos;t in your distro&apos;s repos. Here&apos;s what you can
                do:
              </p>
              <ul className="space-y-2 ml-2">
                <li className="flex gap-2">
                  ...
                  <span>
                    <strong className="text-[var(--text-secondary)]">Use Flatpak/Snap:</strong>{" "}
                    Switch to Flatpak or Snap in the distro selector for universal packages
                  </span>
                </li>
                <li className="flex gap-2">
                  <span className="text-[var(--accent)]">•</span>
                  <span>
                    <strong className="text-[var(--text-secondary)]">Download from website:</strong>{" "}
                    Visit the app&apos;s official site and grab the{" "}
                    <code className="bg-[var(--bg-tertiary)] px-1 rounded">.deb</code>,{" "}
                    <code className="bg-[var(--bg-tertiary)] px-1 rounded">.rpm</code>, or{" "}
                    <code className="bg-[var(--bg-tertiary)] px-1 rounded">.AppImage</code>
                  </span>
                </li>
                <li className="flex gap-2">
                  <span className="text-[var(--accent)]">•</span>
                  <span>
                    <strong className="text-[var(--text-secondary)]">Check GitHub Releases:</strong>{" "}
                ...
                <li className="flex gap-2">
                  <span className="text-[var(--accent)]">•</span>
                  <span>
                    <strong className="text-[var(--text-secondary)]">Hover the ⓘ icon:</strong> Some
                    unavailable apps show links to alternative download methods
                  </span>
                </li>
              </ul>
            </div>
          ...
          <div className="pt-3 border-t border-[var(--border-primary)]">
            ...
            <p className="text-xs text-[var(--text-muted)] leading-relaxed">
              ...
              <strong className="text-[var(--text-secondary)]">AUR</strong> (Arch User Repository).
              TuxMate uses <code className="bg-[var(--bg-tertiary)] px-1 rounded">yay</code> to
              install these. If you don&apos;t have yay, check &quot;I have yay installed&quot; to
              skip auto-installation, or leave it unchecked to install yay first.
            </p>
          </div>
          ...
          <div className="pt-3 border-t border-[var(--border-primary)]">
            ...
            <ul className="space-y-2 text-xs text-[var(--text-muted)] leading-relaxed">
              <li className="flex gap-2">
                ...
                <span>
                  The <strong className="text-[var(--text-secondary)]">download button</strong>{" "}
                  gives you a full shell script with progress tracking, error handling, and a
                  summary
                </span>
              </li>
              <li className="flex gap-2">
                ...
                <span>
                  Your selections are{" "}
                  <strong className="text-[var(--text-secondary)]">saved automatically</strong> —
              ...
              <li className="flex gap-2">
                <span className="text-emerald-500">💡</span>
                <span>
                  Running <code className="bg-[var(--bg-tertiary)] px-1 rounded">.deb</code> files:{" "}
              ...
              <li className="flex gap-2">
                <span className="text-emerald-500">💡</span>
                <span>
                  Running <code className="bg-[var(--bg-tertiary)] px-1 rounded">.rpm</code> files:{" "}
                  <code className="bg-[var(--bg-tertiary)] px-1 rounded">
      ...
      {drawerOpen && (
        <>
          ...
          <div
            ...
            aria-hidden="true"
            style={{
              animation: drawerClosing ? "fadeOut 0.25s ease-out forwards" : "fadeIn 0.2s ease-out",
            }}
          />
  ...
  return parts.map((part, i) => {
    ...
    if (codeMatch) {
      return (
        <code
          key={i}
          className="bg-[var(--bg-primary)] px-1.5 py-0.5 rounded text-[var(--accent)] font-mono text-[10px] select-all break-all"
        >
          {codeMatch[1]}
        </code>
      );
...
export default function Home() {
  ...
  useEffect(() => {
    const handleKeyDown = (e: KeyboardEvent) => {
      ...
      if (
        !["ArrowDown", "ArrowUp", "ArrowLeft", "ArrowRight", "j", "k", "h", "l", "Escape"].includes(
          key
        )
      )
        return;
